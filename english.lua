...
LOGOTEXTURE1="GUI\\logorus1"; --LOGOTEXTURE="GUI\\logo"; -- LOGOTEXTURE1="GUI\\logo1"; --
BACK="Back";
ABOUT="Credits";
BONUSMISSION="Bonus";
MISSION="Mission ";
...
E_COPYRIGHT1="\\I2004-2008 (c) All rights reserved\\i";
...
function MissionInfo(misid, gamemode)
	misid=MissionRemap(misid);
	if (misid==3) then
		StartIntro("Sounds\\rap1.wav", "intro\\taxi", "intro\\slippy", IDT_Nil, "You start the game as a taxi driver who must earn $350 within 15 minutes. The faster you manage to earn the money, the higher your rating will be. Don't forget to refuel your car before running out of petrol. Always watch out for the police!", 0, 0, 100);
	end
	...
	if (misid==7) then
		StartIntro("Sounds\\rap1.wav", "intro\\race", "intro\\slippy", IDT_Nil, "As you are cruising in the stolen luxury car, you spot a beautiful Chinese woman in a cool looking car – she seems to want to race you. Take on the challenge, and make sure you win.", 0, 0, 0);
	end
	...
	if (misid==5) then
		StartIntro("Sounds\\rap2.wav", "intro\\dead_girl", "intro\\slippy", IDT_Nil, "Disaster has struck! The Asian girl you raced was the daughter of your boss, and she was killed while you were supposed to be protecting her. You are in big trouble! After a few days investigating, you discover who killed her - the boss of a rival gang. To clear your name, you must now hunt him down to avenge the daughter’s death.", 20, 20, 20);
	end
...
function page_credits()
	...
	menu_addMenuString("", 0.3, 255, 255, 255); --like in russian--
	menu_addMenuString("Programming", 0.6, 255, 0, 0);
	menu_addMenuString("Ilia Stepanov", 0.5, 255, 255, 255);
	menu_addMenuString("HDBeefup 2022 | dw5", 0.4, 255, 255, 255);
